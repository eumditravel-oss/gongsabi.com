...
# 정확한 정규식 패턴으로 타겟 록온 (5번 데이터 플랫폼 소개 섹션 전체)
pattern = r'<!-- ==========================================\s*5\. 데이터 플랫폼 소개 섹션 \(Data Platform\)\s*=========================================== -->\s*<section class="b2b-section bg-gray b2b-reveal">.*?</section>'
...
new_design_code = """    <!-- ==========================================
         5. 퀵메뉴 및 고객센터 리뉴얼 (Modern Card & AOS)
    =========================================== -->
    <!-- 모던 하단 퀵메뉴 스타일 -->
    <style>
    .b2b-quick-section { padding: 80px 0; background-color: #f8fafc; }
    .b2b-quick-container { max-width: 1200px; margin: 0 auto; padding: 0 15px; }
    .b2b-card {
        background: #fff; border-radius: 12px; padding: 25px; height: 100%;
        box-shadow: 0 4px 15px rgba(0,0,0,0.03); transition: all 0.3s ease; border: 1px solid #edf2f7;
    }
    .b2b-card:hover { transform: translateY(-5px); box-shadow: 0 10px 25px rgba(0,0,0,0.08); border-color:#e2e8f0; }
    ...
    .quick-item {
        ...
        transition: all 0.3s; cursor: pointer; border: 1px solid #edf2f7; color: #4a5568;
    ...
    .contact-box { background: #fff; border-radius: 10px; padding: 20px; border: 1px solid #edf2f7; margin-bottom: 15px; }
    ...
    .contact-box .phone { font-size: 24px; font-weight: 700; color: #1e3a8a; display: flex; align-items: center; letter-spacing: -0.5px; }
    ...
    .notice-list li { padding: 12px 0; border-bottom: 1px dashed #e2e8f0; display: flex; justify-content: space-between; align-items: center; }
    .notice-list li:last-child { border-bottom: none; }
    .notice-list a { color: #4a5568; text-decoration: none; font-size: 14px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 75%; transition: color 0.2s; }
                ...
                <div class="col-lg-4 col-md-12 mb-4" data-aos="fade-up" data-aos-delay="0">
                    <div class="b2b-card" style="background:transparent; border:none; box-shadow:none; padding:0;">
                        <div class="quick-grid">
                            <div class="quick-item" onclick="location.href='/gongsabi.com/front/education/index.html'">
                            ...
                            <div class="quick-item" onclick="location.href='/gongsabi.com/front/company/company3/index.html'">
...
# AOS 플러그인 라이브러리 스크립트가 없다면 문서 하단에 추가
if "aos.js" not in new_content:
...
print("Successfully replaced legacy banner with modern animated quick menu layout and injected AOS plugin!")
