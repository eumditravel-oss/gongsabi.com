                ...
                <div class="col-9">
                    ...
                    <div class="single_shortcodes_are">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="/front/mypage/community/market" role="tab">현장 자재 거래</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/front/mypage/community/recruit" role="tab">구인 / 구직</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/front/mypage/community/gongsabi" role="tab">공사비 작성 의뢰</a>
                            </li>
                        </ul>
                                ...
                                <table class="table classy-table table-bordered table-responsive table-hover gongsabi-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class=""><a href="/front/community/market_view/<?php echo $board->board_seq; ?>"><?php echo $board->board_title; ?></a></td>
                                            ...
                                            <td class="text-center"><button type="button" class="btn btn-sm btn-outline-danger" onclick="board_delete('market', '<?php echo $board->board_seq; ?>', 'Y');">삭제</button></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
