            ...
            <div class="row">
                <div class="col-12 m-top-30">
                    <div class="single_shortcodes_are">
                        ...
                        <form action="/front/mypage/modify_proc/recruit" method="post" class="classy-form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100" id="board_category" name="board_category">
                                        <option value="person"<?php if ( 'person' == $board_data['list'][0]->board_category ) { ?> selected="true"<?php } ?>>구인</option>
                                        <option value="job"<?php if ( 'job' == $board_data['list'][0]->board_category ) { ?> selected="true"<?php } ?>>구직</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <p class="mb-0 my-2"><?php echo GET_FILE_LINK('recruit', $board_data['list'][0]->board_seq, 1); ?></p>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <p class="mb-0 my-2"><?php echo GET_FILE_LINK('recruit', $board_data['list'][0]->board_seq, 2); ?></p>
                                    <?php } ?>  
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <p class="mb-0 my-2"><?php echo GET_FILE_LINK('recruit', $board_data['list'][0]->board_seq, 3); ?></p>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="row m-top-15">
                                <div class="col-lg-6">
                                    ...
                                    <a href="/front/community/recruit_view/<?php echo $board_data['list'][0]->board_seq; ?>" class="btn btn-outline-success">취소</a>
                                    <?php } else { ?>
