                ...
                <div class="col-9">
                    ...
                    <div class="single_shortcodes_are">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="/front/mypage/customer/qna" role="tab">Q&A</a>
                            </li>
                        </ul>
                                ...
                                <table class="table classy-table table-bordered table-responsive table-hover gongsabi-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left"><a href="/front/customer/qna_view/<?php echo $board->board_seq; ?>"><?php echo $board->board_title; ?></a></td>
                                            ...
                                            <td class="text-center"><button type="button" class="btn btn-sm btn-outline-danger" onclick="board_delete('qna', '<?php echo $board->board_seq; ?>', 'Y');">삭제</button></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
