                        ...
                        <form action="/front/community/market_regist_proc" method="post" class="classy-form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100" id="board_category" name="board_category">
                                        <option value="buy" selected="true">삽니다</option>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="board_content" name="board_content" rows="15" placeholder="내용은 500자 이내로 작성해주세요." required="true"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                            ...
                            <div class="row m-top-15">
                                <div class="col-lg-6">
                                    <a href="/front/community/market" class="btn btn-outline-success">취소</a>
                                </div>
