            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="hero-block-content text-center">
                        <h2 class="m-bottom-30 underline-mc">Trade Field Materials</h2>
                        <p>
                            Join our online marketplace which allows contractors to post and search for excess materials in their area from one platform.<br><br>
                                ...
                                <div class="form-group down_arrow">
                                    <div class="dropdown">
                                        <div class="dropdown-title">
                                            ...
                                            <?php foreach ($this->config->item('MARKET_TYPE_ENG') as $key => $gongsabi) { ?>
                                    ...
                                    <!-- <select name="board_category" id="board_category" class="form-control select-align-center">
                                        ...
                                        <option value="buy"<?php echo ( $condition['board_category'] == 'buy' ) ? ' selected="true"' : ''; ?>>Buy</option>
                                        <option value="sell"<?php echo ( $condition['board_category'] == 'sell' ) ? ' selected="true"' : ''; ?>>Sell</option>
                                    </select> -->
                                </div>
                            </div>
                    ...
                    <div class="single_shortcodes_are">
                        ...
                        <table class="table classy-table table-bordered table-responsive table-hover gongsabi-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="/front/community/market_view/<?php echo $board->board_seq; ?>"><?php echo $this->config->item('MARKET_TYPE_ENG')[$board->board_category]; ?></a></td>
                                    <td class="text-center"><a href="/front/community/market_view/<?php echo $board->board_seq; ?>"><?php echo $board->board_title; ?></a></td>
                                    <td class="text-center"><a href="/front/community/market_view/<?php echo $board->board_seq; ?>"><?php echo HP_ENC_TEXT($board->board_company, !$this->session->userdata('MEMBER_SESSION')); ?></a></td>
                                    <td class="text-center"><a href="/front/community/market_view/<?php echo $board->board_seq; ?>"><?php echo HP_ENC_TEXT($board->board_name, !$this->session->userdata('MEMBER_SESSION')); ?></a></td>
                        ...
                        <div class="row m-top-15">
                            <div class="col-lg-12 text-right">
                                ...
                                <a href="/front/community/market_regist" class="btn btn-success">Add post</a>
                                <?php } else { ?>
