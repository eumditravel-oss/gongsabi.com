        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="partners_category_table">
                    <tr>
                        <td class="<?php echo ( $condition['board_category'] == '' ) ? ' active' : ''; ?>"><a class="fss" href="/front/community/partners">전체</a></td>
                        <?php foreach ($this->config->item('PARTNERS_CATEGORY_LIST') as $key => $category) { ?>           
