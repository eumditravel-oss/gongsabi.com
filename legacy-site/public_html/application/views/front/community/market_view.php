                ...
                <div class="col-12 m-top-30">
                    <div class="single_shortcodes_are">
                        ...
                        <div class="row m-top-15">
                            <div class="col-lg-6">
                                <a href="/front/community/market" class="btn btn-outline-success">목록</a>
                            </div>
                            <div class="col-lg-6 text-right">
                                <?php if ( $board_data['list'][0]->ins_user == $this->session->userdata('MEMBER')['member_id'] ) { ?>
                                <a href="/front/mypage/modify/market/<?php echo $board_data['list'][0]->board_seq; ?>?ismypage=0" class="btn btn-success">수정</a>
                                <a href="#" class="btn btn-success" onclick="board_delete('market', '<?php echo $board_data['list'][0]->board_seq; ?>');">삭제</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
