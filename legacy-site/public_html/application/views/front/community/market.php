                                ...
                                <div class="form-group down_arrow">
                                    <div class="dropdown">
                                        <div class="dropdown-title">
                                            ...
                                            <?php foreach ($this->config->item('MARKET_TYPE') as $key => $gongsabi) { ?>
                                    ...
                                    <!-- <select name="board_category" id="board_category" class="form-control select-align-center">
                                        ...
                                        <option value="buy"<?php echo ( $condition['board_category'] == 'buy' ) ? ' selected="true"' : ''; ?>>삽니다</option>
                                        <option value="sell"<?php echo ( $condition['board_category'] == 'sell' ) ? ' selected="true"' : ''; ?>>팝니다</option>
                                    </select> -->
                                </div>
                            </div>
                    ...
                    <div class="single_shortcodes_are">
                        ...
                        <table class="table classy-table table-bordered table-responsive table-hover gongsabi-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="/front/community/market_view/<?php echo $board->board_seq; ?>"><?php echo $this->config->item('MARKET_TYPE')[$board->board_category]; ?></a></td>
                        ...
                        <div class="row m-top-15">
                            <div class="col-lg-12 text-right">
                                ...
                                <a href="/front/community/market_regist" class="btn btn-success">글 작성</a>
                                <?php } else { ?>
