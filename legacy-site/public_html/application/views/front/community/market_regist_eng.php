                ...
                <div class="col-12 m-top-30">
                    <div class="single_shortcodes_are">
                        <div class="single_shortcodes_title m-bottom-30">
                            <h4>Trade Field Materials</h4>
                        </div>

                        <form action="/front/community/market_regist_proc" method="post" class="classy-form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100" id="board_category" name="board_category">
                                        <option value="buy" selected="true">Buy</option>
                            ...
                            <div class="row m-top-15">
                                <div class="col-lg-6">
                                    <a href="/front/community/market" class="btn btn-outline-success">Cancel Post</a>
                                </div>
