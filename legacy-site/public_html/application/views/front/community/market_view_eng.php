                ...
                <div class="col-12 m-top-30">
                    <div class="single_shortcodes_are">
                        <table class="table classy-table table-bordered table-responsive gongsabi-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo $this->config->item('MARKET_TYPE')[$board_data['list'][0]->board_category]; ?></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left" colspan="3">                                             
                                        ...
                                        <p class="mb-0 my-2"><?php echo HP_GET_FILE('market', $board_data['list'][0]->board_seq, '1'); ?></p>
                                        <?php } ?>                                     
                                        <?php if ( $board_data['list'][0]->board_attach_2 ) { ?>
                                        <p class="mb-0 my-2"><?php echo HP_GET_FILE('market', $board_data['list'][0]->board_seq, '2'); ?></p>
                                        <?php } ?>                                     
                                        <?php if ( $board_data['list'][0]->board_attach_3 ) { ?>
                                        <p class="mb-0 my-2"><?php echo HP_GET_FILE('market', $board_data['list'][0]->board_seq, '3'); ?></p>
                                        <?php } ?>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <div class="row m-top-15">
                            <div class="col-lg-6">
                                <a href="/front/community/market" class="btn btn-outline-success">List</a>
                            </div>
                            <div class="col-lg-6 text-right">
                                <?php if ( $board_data['list'][0]->ins_user == $this->session->userdata('MEMBER')['member_id'] ) { ?>
                                <a href="/front/mypage/modify/market/<?php echo $board_data['list'][0]->board_seq; ?>?ismypage=0" class="btn btn-success">Modify Post</a>
                                <a href="#" class="btn btn-success" onclick="board_delete('market', '<?php echo $board_data['list'][0]->board_seq; ?>');">Delete Post</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
