            ...
            <div class="row">
                <div class="col-12 m-top-30">
                    <div class="single_shortcodes_are">
                        ...
                        <form action="/front/customer/qna_modify_proc" method="post" class="classy-form">
                            <input type="hidden" name="board_seq" value="<?php echo $board_list[0]->board_seq; ?>">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="board_name">이름 <small class="text-danger">* 필수</small></label>
                                    <input type="text" class="form-control" id="board_name" name="board_name" placeholder="이름" value="<?php echo $board_list[0]->board_name; ?>" required="true">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="board_company">회사명</label>
                                    <input type="text" class="form-control" id="board_company" name="board_company" placeholder="회사명" value="<?php echo $board_list[0]->board_company; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-email">
                                        <input type="hidden" name="board_email" value="<?php echo $board_list[0]->board_email; ?>">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="board_phone" name="board_phone" placeholder="연락처" value="<?php echo $board_list[0]->board_phone; ?>" required="true">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="board_title">제목 <small class="text-danger">* 필수</small></label>
                                    <input type="text" class="form-control" id="board_title" name="board_title" placeholder="제목" value="<?php echo $board_list[0]->board_title; ?>" required="true">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="board_content">내용 <small class="text-danger">* 필수</small></label>
                                    <textarea class="form-control" id="board_content" name="board_content" cols="30" rows="10" placeholder="내용을 자세히 입력해 주세요." required="true"><?php echo $board_list[0]->board_content; ?></textarea>
                                </div>
                            </div>
                            <div class="row m-top-15">
                                <div class="col-lg-6">
                                    <?php if ( !$this->input->get('ismypage') ) { ?>
                                    <a href="/front/customer/qna_view/<?php echo $board_list[0]->board_seq; ?>" class="btn btn-outline-success">취소</a>
                                    <?php } else { ?>
