(주)공사비닷컴(이하 ‘회사’)은 다음과 같은 원칙에 의하여 회원의 개인정보를 수집, 이용 및 관리하고 있고, 이와 관련하여 정보통신서비스 제공자가 준수하여야 하는 대한민국의 관계법령 및 개인정보보호 규정, 가이드라인을 준수하고 있습니다. 
...
회사는 다음의 목적을 위하여 개인정보를 수집 및 이용합니다. 처리한 개인정보는 다음의 목적 이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.

1) 홈페이지 회원가입 및 관리 

① 서비스 이용에 따른 본인확인 및 개인 식별 
② 불량회원의 부정이용 방지와 비인가 사용 방지 및 중복가입방지 
③ 회원 가입의사 확인, 가입 및 가입횟수 제한 
④ 회원상담 진행, 회원불만 접수 및 처리, 분쟁조정을 위한 기록보존 
⑤ 만 14세 미만 미성년자 개인정보 수집 시 법정대리인 동의 여부 확인, 법정대리인 권리행사 시 본인확인 
⑥ 각종 고지 · 통지 전달 
⑦ 회원제 서비스 제공에 따른 본인 식별·인증

2) 재화 또는 서비스 제공에 관한 계약 이행 및 제공에 따른 요금 정산 
...
① 회원 가입 시 수집항목 
- 로그인 아이디(이메일), 비밀번호, 이름, 휴대폰번호
② 요금 결제 시 수집항목 
- 이름, 휴대폰번호, 배송지
③ 만 14세 미만 미성년자 이용계약 시 수집항목 
- 이름, 휴대폰번호, 이메일, 법정대리인 동의서 
④ PG(결제 대행사) 이용 시 수집항목 
- PG사(NHN KCP) : 상호, 사업자등록번호, 대표자 이름, 사업장주소, 대표 전화번호 
...
- 홈페이지 내 부가서비스 별 페이지 
- 전화, 팩스, 채팅, 이메일을 통한 회원상담 및 서비스 이용관리 
- 이벤트 응모
- 생생정보 수집 툴을 통한 수집
...
회원이 회사의 회원으로서 서비스를 계속 이용하는 동안 회원의 개인정보를 계속 보유하며 서비스 제공 등을 위해 이용합니다. 회원의 개인정보는 그 수집 및 이용 목적(설문조사, 이벤트 등 일시적인 목적을 포함)이 달성되거나 회원이 탈퇴하는 경우에 재생할 수 없는 방법으로 파기됩니다. 
다만, 회원의 권리 남용, 악용 방지, 권리침해/명예훼손 분쟁 및 수사협조 등의 요청이 있었을 경우에는 이의 재발에 대비하여 회원의 탈퇴 시점로부터 1년 동안 회원의 개인정보를 보관할 수 있습니다. 상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 당사는 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다. 이 경우 당사는 보관하는 정보를 그 보관의 목적으로만 이용하며 보존기간은 아래와 같습니다. 
...
① 계약 또는 청약철회 등에 관한 기록 보존 : (전자상거래 등에서의 소비자보호에 관한 법률 보존 기간) 5년 
② 대금결제 및 재화 등의 공급에 관한 기록 보존 : (전자상거래 등에서의 소비자보호에 관한 법률 보존 기간) 5년 
③ 회원의 불만 또는 분쟁처리에 관한 기록 보존 : (전자상거래 등에서의 소비자보호에 관한 법률 보존 기간) 3년 
④ 본인확인에 관한 기록 보존 : (정보통신망 이용촉진 및 정보보호 등에 관한 법률 보존 기간) 6개월 
⑤ 방문에 관한 기록 보존 : (정보통신망 이용촉진 및 정보보호 등에 관한 법률 보존 기간) 3개월 
...
2) 타인에게 정신적, 물질적 피해를 줌으로써 그에 대한 법적 조치를 취하기 위해 고객정보를 공개해야 한다고 판단되는 충분한 근거가 있는 경우.
3) 서비스의 제공에 관한 계약의 이행을 위하여 필요한 개인정보로서 경제적/기술적인 사유로 통상의 동의를 받는 것이 현저히 곤란한 경우.
4) 기타 관련 법령의 규정에 의거하거나, 수사목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우 


5. 개인정보 처리위탁 

회사는 회원서비스 관리 및 민원사항에 대한 처리 등 원활한 업무 수행을 위하여 아래와 같이 개인정보 처리 업무를 위탁하여 운영하고 있습니다. 또한 위탁계약 시 개인정보보호의 안전을 기하기 위하여 개인정보보호 관련 법규의 준수, 개인정보에 관한 제3자 공급 금지 및 사 고시의 책임부담 등을 명확히 규정하고 있습니다. 
1) 결제 및 에스크로 서비스 : NHN KCP 
2) 문자메시지 발송 : 알리고 

동 업체가 변경될 경우, 변경된 업체 명을 공지사항 내지 개인정보처리방침 화면을 통해 고지하겠습니다. 개인정보 처리위탁 시 개인정보 보유 및 이용기간은 회원 탈퇴 시 혹은 위탁계약 종료 시까지 입니다. 
...
② 홈페이지 서비스 유료 이용 회원은 각 서비스 요금제별 이용계약 기간이 서비스를 이용하는 기간으로 적용됩니다. 
...
3) 만 14세 미만 미성년자 법정대리인의 법령 상의 권리를 보장합니다. (만 14세 미성년자의 개인정보에 대한 법정대리인의 열람, 정정/삭제, 개인정보 처리 정지 요구권) 
...
① 보안접속 여부 파악 및 회원이 설정한 서비스 이용 환경을 유지하여 편리한 인터넷 서비스 제공 
② 회원의 방문 및 이용 행태, 인기 검색어 등을 분석하여 최적화된 서비스 제공 
...
- 회사는 개인정보의 훼손에 대비하여 자료를 수시로 백업하고 있고, 최신 백신프로그램을 이용하여 컴퓨터 바이러스 등에 의해 회원들의 개인정보나 자료가 유출되거나 손상되지 않도록 방지하고 있습니다. - 회사는 결제 등의 경우에 있어 네트워크상에서 개인정보를 안전하게 전송할 수 있도록 보안장치를 채택하고 있습니다. 
...
- 이름 : <?php echo $this->config->item('SITE_INFO')[$this->config->item('SITE_LANGUAGE')]['PRIVACY_NAME']; ?> 
- 소속 : <?php echo $this->config->item('SITE_INFO')[$this->config->item('SITE_LANGUAGE')]['PRIVACY_PART']; ?> 
- 직위 : <?php echo $this->config->item('SITE_INFO')[$this->config->item('SITE_LANGUAGE')]['PRIVACY_POSITION']; ?>  
- 전화번호 : <?php echo $this->config->item('SITE_INFO')[$this->config->item('SITE_LANGUAGE')]['TEL1']; ?> 
- 이메일 : <?php echo $this->config->item('SITE_INFO')[$this->config->item('SITE_LANGUAGE')]['EMAIL1']; ?> 
- 팩스번호 : <?php echo $this->config->item('SITE_INFO')[$this->config->item('SITE_LANGUAGE')]['FAX1']; ?>
...
- KISA 개인정보보호 (privacy.kisa.or.kr / 국번 없이 118) 
...
법령·정책 또는 보안기술의 변경에 따라 현 개인정보처리방침 내용의 추가·삭제 및 수정이 있을 시에는 개정안 적용일의 7일 전부터 회사의 홈페이지 내 고지할 것입니다. 다만, 개인정보의 수집 및 활용, 제 3자 제공 등과 같이 회원 권리의 중요한 변경이 있을 경우에는 최소 30일 전에 고지합니다. 
