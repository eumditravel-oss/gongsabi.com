        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form method="post" action="/admin/youtube/regist_proc" class="form-horizontal" role="form">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="p-2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="board_link" name="board_link" class="form-control" value="" required="true" placeholder="유튜브 링크" onchange="setVideo(this);">
                                        <input type="hidden" id="board_etc_1" name="board_etc_1" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="board_title">제목</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="board_title" name="board_title" class="form-control" value="" required="true" placeholder="제목">
                                    </div>
                                </div>
                                <div class="form-group row">
