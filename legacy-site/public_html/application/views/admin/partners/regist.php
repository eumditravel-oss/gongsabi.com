        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Partners 등록</h4>
                </div>
            </div>
        </div>     
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
		            ...
		            <form method="post" action="/admin/partners/regist_proc" enctype="multipart/form-data">

                    <input type="hidden" name="board_type" value="partners">
                    ...
                    <h4 class="header-title">Partners 등록</h4>
                        ...
                        <div class="col-12">
                            <div class="p-2"><div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="board_title" name="board_title" class="form-control" value="" required="true" placeholder="회사명">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="board_link">링크</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="board_link" name="board_link" class="form-control" value="" placeholder="링크">
                                    </div>
                                </div>
                                <div class="form-group row">
