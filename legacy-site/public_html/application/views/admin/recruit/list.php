                        ...
                        <table class="table mb-0">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $this->config->item('RECRUIT_TYPE')[$board->board_category]; ?></td>
                                    <?php if ( $top_yn ) { ?>
                                    ...
                                    <td class="text-center">
                                        <a href="/admin/recruit/modify/<?php echo $board->board_type; ?>/<?php echo $board->board_seq; ?>" class="btn btn-sm btn-primary">수정</a>
                                        <a href="/admin/recruit/delete/<?php echo $board->board_type; ?>/<?php echo $board->board_seq; ?>" class="btn btn-sm btn-danger btn-delete">삭제</a>
                                    </td>
                                </tr>
                            <?php
                            }
