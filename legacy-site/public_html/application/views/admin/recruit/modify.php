        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form method="post" action="/admin/recruit/modify_proc" class="form-horizontal frm_gongsabi_modify" role="form" enctype="multipart/form-data">
                    ...
                    <div class="float-right">
                        <a href="/admin/recruit" class="btn btn-outline-primary waves-effect waves-light"><i class="fa fa-bars mr-1"></i> 목록</a>
                            ...
                            <div class="p-2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <option value="person"<?php echo ( $board_data['list'][0]->board_category == 'person' ) ? ' selected="true"' : ''; ?>>구인</option>
                                        <option value="job"<?php echo ( $board_data['list'][0]->board_category == 'job' ) ? ' selected="true"' : ''; ?>>구직</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
