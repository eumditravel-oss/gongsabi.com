            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="float-right">
                        ...
                        <form method="post" action="/admin/contact/download" id="frm_download">
                        </form>
                    </div>
                        ...
                        <table class="table mb-0">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $board->board_phone; ?></td>
                                    <td class="text-center"><?php echo $board->ins_datetime; ?></td>
                                    <td class="text-center"><?php echo $board->upd_datetime; ?></td>
                                    <td class="text-center">
                                        <a href="/admin/contact/modify/<?php echo $board->board_type; ?>/<?php echo $board->board_seq; ?>?page=<?php echo $this->input->get('page'); ?>" class="btn btn-sm btn-primary">수정</a>
                                        <a href="/admin/contact/delete/<?php echo $board->board_type; ?>/<?php echo $board->board_seq; ?>?page=<?php echo $this->input->get('page'); ?>" class="btn btn-sm btn-danger btn-delete">삭제</a>
                                    </td>
                                </tr>
                            <?php
                            }
