        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
		            ...
		            <form method="post" action="/admin/lecture/teacher_regist_proc" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            <div class="p-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="teacher_name" name="teacher_name" class="form-control" value="" required="true" placeholder="강사 이름">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-form-label" for="teacher_desc">강사 소개</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="teacher_desc" rows="5" placeholder="강사 소개"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-form-label" for="teacher_name_eng">강사 이름(영문)</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="teacher_name_eng" name="teacher_name_eng" class="form-control" value="" required="true" placeholder="강사 이름(영문)">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-form-label" for="teacher_desc_eng">강사 소개(영문)</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="teacher_desc_eng" rows="5" placeholder="강사 소개(영문)"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
