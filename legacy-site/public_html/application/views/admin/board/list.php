                        ...
                        <table class="table mb-0">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/admin/board/modify/<?php echo $board->board_type; ?>/<?php echo $board->board_seq; ?>" class="btn btn-sm btn-primary">수정</a>
                                        <a href="/admin/board/delete/<?php echo $board->board_type; ?>/<?php echo $board->board_seq; ?>" class="btn btn-sm btn-danger btn-delete">삭제</a>
                                    </td>
                                </tr>
                            <?php
                            }
