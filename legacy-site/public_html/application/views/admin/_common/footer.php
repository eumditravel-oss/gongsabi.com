                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                               2020 &copy; <?php echo $this->config->item('site_name'); ?>
                            </div>
                            <div class="col-md-6">
                                <div class="text-md-right footer-links d-none d-sm-block">
                                    Powered by <a href="javascript:void(0);">SOULJAM WORKS</a>.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="/static/admin/assets/libs/jquery-knob/jquery.knob.min.js"></script>
        <script src="/static/admin/assets/libs/peity/jquery.peity.min.js"></script>

        <!-- Sparkline charts -->
        <script src="/static/admin/assets/libs/jquery-sparkline/jquery.sparkline.min.js"></script>

        <!-- init js -->
        <script src="/static/admin/assets/js/pages/dashboard-1.init.js"></script>
...
<script>
$(function() {
    $('#btn_gongsabi_modify').on('click', function() {
        if ( $('#board_reply_content').length > 0 && $('#board_reply_content').val() != '' ) {
            if ( confirm('수정 완료 후 답변 완료 문자 메시지를 전송 하시겠습니까 ?') ) {
                $('#board_sms_yn').val('T');
            }
        }         
        $('.frm_gongsabi_modify').submit();
    });
});
</script>
