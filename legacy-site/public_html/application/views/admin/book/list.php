            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="float-right">
                        ...
                        <form method="post" action="/admin/book/download" id="frm_download">
                        </form>
                    </div>
                        ...
                        <table class="table mb-0">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $this->config->item('ORDER_STATUS')[$board->board_etc_3]['name']; ?></td>
                                    <td class="text-center"><?php echo $this->config->item('BOOK_LIST')[$board->board_category]['name']; ?></td>
                                    <td class="text-center"><?php echo $board->board_etc_2; ?></td>
                                    <td class="text-center"><?php echo $board->board_name; ?></td>
                                    <td class="text-center"><?php echo $board->board_hp; ?></td>
                                    <td class="text-center"><?php echo $board->ins_datetime; ?></td>
                                    <td class="text-center"><?php echo $board->upd_datetime; ?></td>
                                    <td class="text-center">
                                        <a href="/admin/book/modify/book/<?php echo $board->board_seq; ?>" class="btn btn-sm btn-primary">수정</a>
                                        <a href="/admin/book/delete/book/<?php echo $board->board_seq; ?>" class="btn btn-sm btn-danger btn-delete">삭제</a>
                                    </td>
                                </tr>
                            <?php
                            }
