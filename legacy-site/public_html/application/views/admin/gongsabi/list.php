            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="float-right">
                        ...
                        <form method="post" action="/admin/gongsabi/download" id="frm_download">
                        </form>
                    </div>
                        ...
                        <table class="table mb-0">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo HP_GET_GONGSABI_REQUEST_TEXT($board->board_category); ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="/admin/gongsabi/modify/<?php echo $board->board_type; ?>/<?php echo $board->board_seq; ?>" class="btn btn-sm btn-primary">수정</a>
                                        <a href="/admin/gongsabi/delete/<?php echo $board->board_type; ?>/<?php echo $board->board_seq; ?>" class="btn btn-sm btn-danger btn-delete">삭제</a>
                                    </td>
                                </tr>
                            <?php
                            }
