...
class Market extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('admin/market/list', $data);
    ...
    public function regist()
    {
        ...
        $this->load->view('admin/_common/header');
        $this->load->view('admin/market/regist', $data);
        $this->load->view('admin/_common/footer');  
    }
    ...
    public function regist_proc()
    {
        ...
        if ( $result )
        {
            ...
            redirect('/admin/market/'.$board_type);
        }
        else
            redirect('/admin/market/'.$board_type);
    }
    ...
    public function modify($board_type, $board_seq)
    {
        ...
        $this->load->view('admin/_common/header');
        $this->load->view('admin/market/modify', $data);
        $this->load->view('admin/_common/footer');  
    }
    ...
    public function modify_proc()
    {
        ...
        if ( $result )
        {
            ...
            redirect('/admin/market/modify/'.$board_type.'/'.$board_seq);
        }
        else
            redirect('/admin/market/modify/'.$board_type.'/'.$board_seq);
    }
